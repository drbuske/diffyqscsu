...
{
  "id": "02-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-2.html#02-prep-cardsort1",
  "type": "Exercise",
  "number": "6",
  "title": "Sorting Differential Equations.",
  "body": " Sorting Differential Equations   Sort each differential equation into the appropriate category.           The set    Linear ordinary differential equation               Nonlinear ordinary differential equation            Partial differential equation     "
},
{
  "id": "order-of-de",
  "level": "2",
...
{
  "id": "11-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-3.html#11-prep-cardsort1",
  "type": "Exercise",
  "number": "7",
  "title": "Sorting Solutions to ODEs.",
  "body": " Sorting Solutions to ODEs   Sort each solution to an appropriate differential equation.                                        "
},
{
...
{
  "id": "12-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-4.html#12-prep-cardsort1",
  "type": "Exercise",
  "number": "5",
  "title": "Sorting Slope Field Characteristics of ODEs.",
  "body": " Sorting Slope Field Characteristics of ODEs   Sort the following into the appropriate category.        All slope segments have the same positive slope everywhere in the plane.  Solution curves are straight lines with constant slope.   Slope depends on neither nor        Slopes change as you move left or right, but are the same along vertical lines.  Slope segments are horizontal along the -axis.   Slope depends only on        Slopes change as you move up or down, but are the same along horizontal lines.  Slope segments are horizontal along the -axis.   Slope depends only on        Slope segments are horizontal along the line .  Slopes increase when increases and decrease when increases.   Slope depends on both and        All slopes are nonnegative.  Slope segments get steeper as increases.   Slope is always zero or positive     "
},
{
...
{
  "id": "sec-Toprepareforclass12-4-17",
  "level": "2",
  "url": "ch-Textbook-4.html#sec-Toprepareforclass12-4-17",
  "type": "Exercise",
  "number": "16",
  "title": "",
...
{
  "id": "13-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-5.html#13-prep-cardsort1",
  "type": "Exercise",
  "number": "6",
  "title": "Separable or Not?",
  "body": " Separable or Not?   Sort the following as separable or not.               Separable differential equation               Not separable in its given form     "
},
{
...
{
  "id": "sec-Toprepareforclass13-4-9",
  "level": "2",
  "url": "ch-Textbook-5.html#sec-Toprepareforclass13-4-9",
  "type": "Exercise",
  "number": "8",
  "title": "",
...
{
  "id": "14-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-6.html#14-prep-cardsort1",
  "type": "Exercise",
  "number": "5",
  "title": "First-order linear ODE or Not?",
  "body": " First-order linear ODE or Not?   A first-order ordinary differential equation is linear if it can be written in the form . Sort each equation into the appropriate category.                     First-order linear ordinary differential equation            Nonlinear first-order ordinary differential equation     "
},
{
...
{
  "id": "16-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-7.html#16-prep-cardsort1",
  "type": "Exercise",
  "number": "7",
  "title": "Autonomous ODE behavior.",
  "body": " Autonomous ODE behavior   Sort the statements so that they correctly describe the behavior of solutions to each equation.     Autonomous equation with a stable equilibrium  Solutions decrease when and increase when .  All solutions approach as .       Autonomous equation with an unstable equilibrium  Solutions with increase without bound.        Autonomous equation with multiple equilibria   and are equilibrium solutions.  Solutions decrease when .  Solutions with increase without bound.       "
},
{
...
{
  "id": "17-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-8.html#17-prep-cardsort1",
  "type": "Exercise",
  "number": "6",
  "title": "Comparing Euler’s method to exact solutions.",
  "body": " Comparing Euler's method to exact solutions   Sort the statements to the appropriate initial value problem.     Euler’s method produces a solution that lies below the exact solution.  The exact solution curve is increasing.    , with     Euler’s method produces a solution that lies above the exact solution.  The exact solution curve is decreasing.    , with     The slope alternates between positive and negative.  Euler’s method is likely to overshoot local maxima and minima of the exact solution.    , with     "
},
{
...
{
  "id": "21-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-9.html#21-prep-cardsort1",
  "type": "Exercise",
  "number": "6",
  "title": "Linear independence of two functions.",
  "body": " Linear independence of two functions   Determine whether the two functions are linearly independent or linearly dependent .            Linearly dependent                  Linearly independent     "
},
{
...
{
  "id": "22-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-10.html#22-prep-cardsort1",
  "type": "Exercise",
  "number": "6",
  "title": "Grouping Constant-Coefficient Second-Order Differential Equation Behaviors.",
  "body": " Grouping Constant-Coefficient Second-Order Differential Equation Behaviors   Each item described matches one of the given constant-coefficient ODEs.        Characteristic equation:   Two distinct real roots  General solution involves exponentials            Characteristic equation:   Complex conjugate roots  Solutions oscillate            Characteristic equation:   Repeated real root  One solution must be multiplied by             Characteristic equation:   Complex roots with negative real part  Oscillations with exponential decay         "
},
{
...
{
  "id": "23-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-11.html#23-prep-cardsort1",
  "type": "Exercise",
  "number": "6",
  "title": "Understanding Higher-Order Linear Differential Equations.",
  "body": " Understanding Higher-Order Linear Differential Equations   Higher-order linear differential equations have solution spaces whose structure depends on the order of the equation. Sort each pair of statements so that they belong together.        Two initial conditions are required to determine a unique solution.   Second-order linear differential equation        Three linearly independent solutions are needed.   Third-order linear differential equation        Any solution is a linear combination of these functions.   Fundamental solution set     "
},
{
  "id": "higherorder-1",
  "level": "2",
...
{
  "id": "24-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-12.html#24-prep-cardsort1",
  "type": "Exercise",
  "number": "6",
  "title": "Interpreting Mechanical Vibration Models.",
  "body": " Interpreting Mechanical Vibration Models   Each differential equation below models the motion of a mass attached to a spring, possibly with damping or external forcing. Sort the equations so that they match the correct physical behavior.        No damping or external force is present.   Undamped free vibration        Motion eventually decays to equilibrium.   Damped free vibration        Oscillations persist due to an external driving force.   Undamped forced vibration        Long-term motion approaches a steady oscillation.   Damped forced vibration        The mass returns to equilibrium without oscillating.   Overdamped motion     "
},
{
...
{
  "id": "25-prep-cardsort1",
  "level": "2",
  "url": "ch-Textbook-13.html#25-prep-cardsort1",
  "type": "Exercise",
  "number": "13",
  "title": "Undetermined Coefficients or Variation of Parameters?",
  "body": " Undetermined Coefficients or Variation of Parameters?   Each differential equation below is linear and nonhomogeneous. Decide whether it is more appropriate to use the method of undetermined coefficients or the method of variation of parameters to find a particular solution.               Use undetermined coefficients               Use variation of parameters     "
},
{
...
{
  "id": "31-prep-cardsort-laplace",
  "level": "2",
  "url": "ch-Textbook-14.html#31-prep-cardsort-laplace",
  "type": "Exercise",
  "number": "6",
  "title": "Choosing the Laplace Transform Method.",
  "body": " Choosing the Laplace Transform Method   Each differential equation below can be solved using different methods. Sort the equations according to whether the Laplace transform is especially well suited for solving the problem.               Laplace transform is especially useful               Better suited for earlier methods     "
},
{
...
{
  "id": "32-prep-cardsort-laplace-derivatives-ode",
  "level": "2",
  "url": "ch-Textbook-15.html#32-prep-cardsort-laplace-derivatives-ode",
  "type": "Exercise",
  "number": "5",
  "title": "Matching Differential Equations with Their Laplace Transforms.",
  "body": " Matching Differential Equations with Their Laplace Transforms   Each differential equation below has been transformed using the Laplace transform. Match each differential equation with its correct transformed equation in the -domain.                                         "
},
{
...
{
  "id": "33-prep-cardsort-convolution",
  "level": "2",
  "url": "ch-Textbook-16.html#33-prep-cardsort-convolution",
  "type": "Exercise",
  "number": "6",
  "title": "Recognizing Convolution in Differential Equations.",
  "body": " Recognizing Convolution in Differential Equations   Convolution appears naturally when solving linear differential equations with forcing terms using Laplace transforms. Match each situation with the correct interpretation or expression involving convolution.                              "
},
{
  "id": "conv-purpose",
  "level": "2",
...
{
  "id": "34-prep-cardsort-dirac-delta",
  "level": "2",
  "url": "ch-Textbook-17.html#34-prep-cardsort-dirac-delta",
  "type": "Exercise",
  "number": "7",
  "title": "Interpreting the Dirac Delta Function.",
  "body": " Interpreting the Dirac Delta Function   The Dirac delta function is used to model instantaneous forces or inputs in differential equations. Sort the equations and conclusions so that each group correctly describes the effect of the delta function.        The solution is continuous, but its derivative has a jump at .   Impulse forcing causes a sudden change in velocity        The forcing occurs instantaneously at .  The solution has a jump discontinuity at .   Impulse causes a sudden change in the solution value        All changes in the solution occur smoothly over time.   No impulsive forcing     "
},
{
  "id": "delta-open-1",
  "level": "2",
...
{
  "id": "41-prep-cardsort-vectors-maps",
  "level": "2",
  "url": "ch-Textbook-18.html#41-prep-cardsort-vectors-maps",
  "type": "Exercise",
  "number": "9",
  "title": "Vectors, Mappings, and Matrices.",
  "body": " Vectors, Mappings, and Matrices   Vectors, mappings, and matrices are closely related objects, but they play different roles. Sort the items below so that expressions, interpretations, and descriptions that belong together are grouped correctly.        An element of   An arrow having magnitude and direction   Vector        Takes a vector as input and produces a vector as output   for all scalars    Linear mapping        Represents a linear transformation   Matrix     "
},
{
  "id": "linop-definition",
  "level": "2",
...
{
  "id": "42-prep-matrix-multiplication",
  "level": "2",
  "url": "ch-Textbook-19.html#42-prep-matrix-multiplication",
  "type": "Exercise",
  "number": "6",
...
{
  "id": "43-prep-augmented-system",
  "level": "2",
  "url": "ch-Textbook-20.html#43-prep-augmented-system",
  "type": "Exercise",
  "number": "10",
  "title": "Linear systems and augmented matrices.",
  "body": "  Linear systems and augmented matrices   If possible, match each linear system on the left to its corresponding augmented matrix. Not all systems may be used.                                        "
},
{
  "id": "a3-elem-row-ops",
  "level": "2",
...
},
{
  "id": "44-prep-matchdim",
  "level": "2",
  "url": "ch-Textbook-21.html#44-prep-matchdim",
  "type": "Exercise",
  "number": "6",
...
{
  "id": "sec-Toprepareforclass44-4-13",
  "level": "2",
  "url": "ch-Textbook-21.html#sec-Toprepareforclass44-4-13",
  "type": "Exercise",
  "number": "12",
  "title": "",
...
{
  "id": "51-prep-cardsort-intro-systems",
  "level": "2",
  "url": "ch-Textbook-22.html#51-prep-cardsort-intro-systems",
  "type": "Exercise",
  "number": "6",
  "title": "Understanding Systems of Differential Equations.",
  "body": " Understanding Systems of Differential Equations   A system of differential equations describes how several quantities change together. Sort the equations and interpretations so that items that belong together are grouped correctly.        Two first-order equations describe the evolution of two variables.   System of first-order differential equations        Can be rewritten as a first-order system by introducing new variables.   Single higher-order equation equivalent to a system         Matrix representation of a system     "
},
{
...
{
  "id": "52-prep-cardsort-determinant-values",
  "level": "2",
  "url": "ch-Textbook-23.html#52-prep-cardsort-determinant-values",
  "type": "Exercise",
  "number": "7",
  "title": "Computing Determinant Values.",
  "body": " Computing Determinant Values   Each card contains a small matrix. Compute the determinant of each matrix and sort the matrices according to their determinant values.            Determinant equals            Determinant equals            Determinant equals            Determinant equals     "
},
{
...
{
  "id": "53-prep-cardsort-linear-systems",
  "level": "2",
  "url": "ch-Textbook-24.html#53-prep-cardsort-linear-systems",
  "type": "Exercise",
  "number": "6",
  "title": "Interpreting Linear Systems of Differential Equations.",
  "body": " Interpreting Linear Systems of Differential Equations   Linear systems of differential equations can be represented and interpreted in several equivalent ways. Sort the equations and descriptions so that each group correctly describes a single type of linear system behavior or structure.        The equations can be solved independently.   Decoupled linear system        Each equation depends on both variables.   Coupled linear system     "
},
{
  "id": "linsysopen1",
  "level": "2",
...
{
  "id": "54-prep-cardsort-eigenmethod",
  "level": "2",
  "url": "ch-Textbook-25.html#54-prep-cardsort-eigenmethod",
  "type": "Exercise",
  "number": "8",
  "title": "Interpreting the Eigenvalue Method for Linear Systems.",
  "body": " Interpreting the Eigenvalue Method for Linear Systems   The eigenvalue method is used to solve linear systems of the form . Sort the matrices, eigenvalue information, and solution descriptions so that items that belong together are grouped correctly.        Eigenvalues: ,    Solutions involve exponentials and         Eigenvalues are purely imaginary   Solutions are oscillatory        Both eigenvalues are negative   All solutions decay to the origin     Matrix has a repeated real eigenvalue  Only one linearly independent eigenvector exists   General solution includes a term multiplied by      "
},
{
...
{
  "id": "55-prep-cardsort-two-dim-autonomous",
  "level": "2",
  "url": "ch-Textbook-26.html#55-prep-cardsort-two-dim-autonomous",
  "type": "Exercise",
  "number": "5",
  "title": "Interpreting Two-Dimensional Autonomous Systems.",
  "body": " Interpreting Two-Dimensional Autonomous Systems   A two-dimensional autonomous system has the form . Such systems are studied using equilibrium points and phase-plane analysis. Sort the systems and descriptions so that items that belong together are grouped correctly.        Solutions form closed orbits around the origin.   Center equilibrium        Trajectories approach the origin along one direction and move away along another.   Saddle point        All nearby solutions move toward the origin as time increases.   Stable node        Solutions spiral outward from the origin.   Unstable spiral     "
},
{
  "id": "twodim-open-1",
  "level": "2",
...
{
  "id": "56-prep-cardsort-second-order-behavior",
  "level": "2",
  "url": "ch-Textbook-27.html#56-prep-cardsort-second-order-behavior",
  "type": "Exercise",
  "number": "6",
  "title": "Second-Order Systems and Phase-Plane Behavior.",
  "body": " Second-Order Systems and Phase-Plane Behavior   Second-order differential equations can be rewritten as systems and interpreted geometrically in the phase plane using position and velocity. Sort each equation so that it matches the correct qualitative behavior of its solutions.     Closed orbits in the phase plane  Energy is conserved and solutions repeat periodically.       Trajectories approach the origin monotonically  Motion decays smoothly to equilibrium without oscillation.       Spiral motion toward the origin  Oscillations occur with decreasing amplitude.       Saddle-type instability  Small disturbances grow rapidly over time.       "
},
{
...
{
  "id": "57-prep-cardsort-multiple-eigenvalues",
  "level": "2",
  "url": "ch-Textbook-28.html#57-prep-cardsort-multiple-eigenvalues",
  "type": "Exercise",
  "number": "6",
  "title": "Linear Systems with Repeated Eigenvalues.",
  "body": " Linear Systems with Repeated Eigenvalues   Some linear systems have repeated eigenvalues. The structure of the solution depends on whether there are enough linearly independent eigenvectors. Sort the systems and descriptions so that items that belong together are grouped correctly.      matrix has a repeated eigenvalue and two linearly independent eigenvectors exist  Matrix has distinct eigenvalues   General solution to uses two exponential solutions      matrix has a repeated eigenvalue and only one linearly independent eigenvector exists   General solution includes a term     "
},
{
  "id": "multeigennew1",
  "level": "2",
...
{
  "id": "58-prep-cardsort-matrix-exponential-simple",
  "level": "2",
  "url": "ch-Textbook-29.html#58-prep-cardsort-matrix-exponential-simple",
  "type": "Exercise",
  "number": "6",
  "title": "Understanding the Matrix Exponential.",
  "body": " Understanding the Matrix Exponential   The matrix exponential is used to solve linear systems of the form . Sort the expressions so that each system is matched with the correct form of its solution.                            Single eigenvalue with one eigenvector    contains a factor of      "
},
{
  "id": "matexpnew1",
  "level": "2",
...
{
  "id": "59-prep-cardsort-nonhomogeneous-systems",
  "level": "2",
  "url": "ch-Textbook-30.html#59-prep-cardsort-nonhomogeneous-systems",
  "type": "Exercise",
  "number": "6",
  "title": "Understanding Nonhomogeneous Linear Systems.",
  "body": " Understanding Nonhomogeneous Linear Systems   A nonhomogeneous linear system has the form . Sort the equations and descriptions so that items that belong together are grouped correctly.        No external forcing is present.   Homogeneous linear system        An external input affects the system.   Nonhomogeneous linear system        Solves the associated homogeneous system.   Homogeneous solution        Depends on the forcing term .   Particular solution        Describes the general solution of the system.   General solution of a nonhomogeneous system     "
},
{
  "id": "nonhomog-open-1",
  "level": "2",
